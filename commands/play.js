        ...
        try {
            if (SearchString.match(client.Lavasfy.spotifyPattern)) {
                ...
                if (Searched.loadType === "PLAYLIST_LOADED") {
                    ...
                    SongAddedEmbed.setAuthor(`The PlyList has been added`, message.author.displayAvatarURL());
                    ...
                    SongAddedEmbed.setAuthor(`Song Added`, client.config.IconURL);
                ...
                switch (res.loadType) {
                    ...
                    case "SEARCH_RESULT":
                        ...
                        if (!player.playing && !player.paused && !player.queue.length) {
                            ...
                            player.play();
                            return interaction.send(SongAddedEmbed);
                            await embed.react("842097668414242856")
                        } else {
                            let SongAddedEmbed = new MessageEmbed();
                            SongAddedEmbed.setAuthor(`Added to queue`, client.config.IconURL);
                            SongAddedEmbed.setThumbnail(track.displayThumbnail());
